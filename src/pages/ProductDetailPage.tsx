    ...
    const fetchRelatedProducts = async () => {
      ...
      try {
        ...
        if (Array.isArray(relatedData)) {
          ...
          console.error("relatedData is not an array:", relatedData);
        }
      } catch (error) {
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <Button asChild className="bg-navy-900 hover:bg-navy-800">
              <Link to={`/products?userId=${userId || "no_name"}`}>Back to Products</Link>
            </Button>
          </div>
        </main>
        <Footer />
              ...
              <div className="space-y-4 pt-2 border-t border-gray-100">
                ...
                <div>
                  ...
                  <Select value={selectedSize} onValueChange={setSelectedSize}>
                    ...
                    <SelectContent>
                      {product.sizes
                        .filter((size) => size.trim() !== "") // filter out empty or whitespace-only
                        .map((size) => (
